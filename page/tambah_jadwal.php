...
$insertjadwal = mysqli_query(
    $koneksi,
    "INSERT INTO jadwal VALUES ('$kd_jadwal', '$kd_guru', '$semester', '$tahun_ajaran')"
);
...
for ($i = 0; $i < count($kd_mapel); $i++) {
    $insert = mysqli_query(
        $koneksi,
        "INSERT INTO detailjadwal (kd_jadwal, kd_mapel, Hari, Jam, Kelas)
            ...
            <div class="card-body">
                ...
                <form method="POST" action="">
                    <div class="form-group">
                        ...
                        <input type="text" name="kd_jadwal"
